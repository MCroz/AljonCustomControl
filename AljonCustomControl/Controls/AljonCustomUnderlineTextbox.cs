...
{
    public class AljonCustomUnderlineTextbox : Control, IAljonCustomControl
    {
        #region Variables
        //Mga Variables para sa Customized Textbox
        [Browsable(false)]
        ...
        private Color underLineFocusedColor;
        private Color foreColor;
        private Color underLineUnfocusedColor;
        ...
        public AljonCustomUnderlineTextbox()
        {
            ...
            BackColorChanged += (sender, args) =>
            {
                ...
                baseTextBox.BackColor = customBackColor;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            baseTextBox.Font = AljonFont;
            baseTextBox.BackColor = customBackColor;

            //fix para sa height
            Height = baseTextBox.Height + 5;

            Brush focusedBrush = new SolidBrush(underLineFocusedColor);
            //Color DIVIDERS_BLACK = Color.FromArgb(31, 0, 0, 0);
            Brush unfocusedBrush = new SolidBrush(underLineUnfocusedColor);
            ...
            if (!animationManager.IsAnimating())
            {
                ...
                g.FillRectangle(baseTextBox.Focused ? focusedBrush : unfocusedBrush, baseTextBox.Location.X, lineY, baseTextBox.Width, baseTextBox.Focused ? 2 : 1);
            }
            else
            {
                //Animate
                ...
                g.FillRectangle(unfocusedBrush, baseTextBox.Location.X, lineY, baseTextBox.Width, 1);
                ...
                g.FillRectangle(focusedBrush, animationStart - halfAnimationWidth, lineY, animationWidth, 2);
            }
        }
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            //baseTextBox.Size = new Size(Width, Height - 5);
        }
        ...
        public Color CustomFocusedUnderlineColor
        {
            get
            {
                return this.underLineFocusedColor;
            }

            set
            {
                this.underLineFocusedColor = value;
                this.Invalidate();
            }
        }
        public Color CustomUnfocusedUnderlineColor
        {
            get
            {
                return this.underLineUnfocusedColor;
            }

            set
            {
                this.underLineUnfocusedColor = value;
                this.Invalidate();
            }
        }
